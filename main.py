...
def update_layout():
    ...
    # inputs_height = min(max(port_height * 0.25, 100), 500)

    outputs_width = min(max(port_width * 0.15, 100), 500)
    # outputs_height = min(max(port_height * 0.25, 100), 500)
    ...
    if dpg.does_item_exist("temp_text"):
        dpg.configure_item("temp_text", width=inputs_width)
    if dpg.does_item_exist("energy_text"):
        dpg.configure_item("energy_text", width=inputs_width)
    if dpg.does_item_exist("bads_text"):
        dpg.configure_item("bads_text", width=inputs_width)
    if dpg.does_item_exist("time_text"):
        dpg.configure_item("time_text", width=inputs_width)
    ...
    if dpg.does_item_exist("plot_energy"):
        dpg.configure_item("plot_energy", width=plots_width, height=plots_height)
